...
function DropdownMenuCheckboxes({notificationChannels}: DropdownMenuCheckboxesProps) {
    ...
    return (<DropdownMenu>
        ...
        <DropdownMenuContent className="w-56">
            ...
            <DropdownMenuSeparator/>
            {notificationChannels.map(channel => (<DropdownMenuCheckboxItem
                key={channel.id}
...
export function ProfileForm({setOpen, className, ...formProps}: ProfileFormProps) {
    ...
    const handleSubmit = async (e: { preventDefault: () => void; }) => {
        ...
        const formData = {
            ...
            periodic_task: {
                name: taskName, task, interval: {
                    every: intervalEvery, period: intervalPeriod
                }, enabled
            }
        };
